...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div
      className={`relative bg-white box-shadow-lg border-1 border-[#E8EAED] border-solid rounded-xl p-6 shadow-lg transition-all duration-300 transform group h-full flex flex-col ${isComingSoon
    ...
    >
      ...
      <div className="flex gap-2 mb-4">
        <span className={`px-3 py-1 rounded-full text-xs font-medium border transition-all duration-300 ${isComingSoon
      ...
      <div className="flex justify-center mb-4">
        <div className={`text-4xl transition-all duration-300 ${isComingSoon
          ? 'text-gray-400'
      ...
      <div className="flex items-center justify-center gap-2 mb-3">
        <h3 className={`text-xl font-bold transition-colors duration-300 ${isComingSoon
          ? 'text-gray-500'
          : 'text-gray-800'
          }`}>{title}</h3>
      </div>
      ...
      {/* Description */}
      <p className={`text-center mb-6 leading-relaxed transition-colors duration-300 flex-grow ${isComingSoon
        ? 'text-gray-500'
      ...
      {/* Button */}
      <button
        className={`w-full py-3 px-4 rounded-lg font-medium transition-all duration-300 transform border-2 ${isComingSoon
