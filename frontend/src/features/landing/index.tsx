                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <button className="px-8 py-4 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-100 font-bold rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors text-lg font-display">
                                Xem giới thiệu
                            </button>
                        </div>
        ...
        <section className="py-24 bg-[#f6f7f8] dark:bg-slate-950" id="features">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl font-display text-slate-900 dark:text-slate-100">Chế độ học tập tùy chỉnh</h2>
                    <p className="text-slate-600 dark:text-slate-400 text-lg font-display">Chọn phong cách luyện tập phù hợp nhất với mục tiêu và trình độ hiện tại của bạn.</p>
                </div>
                <div className="grid gap-8 md:grid-cols-2">
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold mb-3 font-display text-slate-900 dark:text-slate-100">Luyện dịch câu đơn</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-display">Tập trung vào độ chính xác và ngữ pháp ở cấp độ vi mô. Hoàn hảo để nắm vững các thì và giới từ cụ thể.</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold mb-3 font-display text-slate-900 dark:text-slate-100">Luyện dịch đoạn văn</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-display">Làm chủ dòng chảy, ngữ cảnh và các cấu trúc câu nâng cao. Học cách kết nối các ý tưởng một cách tự nhiên và chuyên nghiệp.</p>
                    </motion.div>
                </div>
            </div>
        </section>
        ...
        <section className="py-24 bg-[#f6f7f8] dark:bg-slate-950">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20">
                    <h2 className="text-3xl font-bold tracking-tight mb-4 font-display text-slate-900 dark:text-slate-100">Cách thức hoạt động</h2>
                    <p className="text-slate-600 dark:text-slate-400 font-display">Ba bước đơn giản để đạt được sự lưu loát.</p>
                </div>
                <div className="grid md:grid-cols-4 gap-12 relative">
                    ...
                    {steps.map((step) => (
                        <div key={step.id} className="relative z-10 flex flex-col items-center text-center group">
                            ...
                            <h3 className="mt-6 text-xl font-bold font-display text-slate-900 dark:text-slate-100">{step.title}</h3>
                            <p className="mt-3 text-slate-600 dark:text-slate-400 font-display">{step.desc}</p>
                        </div>
                    ))}
                </div>
            </div>
