          ...
          <>
            ...
            {second && (
              <div className="flex flex-col items-center">
                ...
                <div className="bg-white w-full sm:w-56 pt-6 pb-4 rounded-t-2xl border-t-4 border-slate-300 shadow-sm text-center">
            ...
            <div className="flex flex-col items-center z-10 md:-mx-2">
              ...
              <div className="bg-white w-full sm:w-64 pt-8 pb-6 rounded-t-2xl border-t-4 border-amber-400 shadow-lg text-center relative">
            ...
            {third && (
              <div className="flex flex-col items-center">
                ...
                <div className="bg-white w-full sm:w-56 pt-6 pb-4 rounded-t-2xl border-t-4 border-orange-700 shadow-sm text-center">
                  <h3 className="font-bold text-slate-900">
        ...
        <div className="p-4 sm:p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 bg-slate-50/50">
          ...
          <div className="relative w-full sm:w-auto">
            ...
            <input
              ...
              className="w-full sm:w-64 pl-9 pr-4 py-2 text-sm border border-slate-200 rounded-lg bg-white focus:outline-none focus:border-primary"
            />
          </div>
        </div>
        {isLoading ? (
              ...
              <table className="w-full min-w-[640px] text-left">
                ...
                <tbody className="divide-y divide-slate-50">
                  {rows.map((row) => (
                    ...
                    >
                      <td className="px-4 sm:px-6 py-3 sm:py-4 font-bold text-slate-500">
                        #{row.rank}
                      </td>
