  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:px-6 lg:px-8 space-y-8 pb-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900">Chào mừng quay lại, {profile?.fullName}! 👋</h1>
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-bold text-slate-900">Hiệu suất viết</h3>
            <select
              value={range}
              onChange={(e) => setRange(e.target.value as WritingPerformanceRange)}
              className="bg-slate-50 border-none text-sm text-slate-600 rounded-lg px-3 py-1 cursor-pointer hover:bg-slate-100"
            >
