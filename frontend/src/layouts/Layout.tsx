...
const Layout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50">
      {/* Desktop Sidebar */}
      <aside
        className={`hidden md:flex flex-col bg-white border-slate-200 z-10 transition-all duration-300 ease-in-out overflow-hidden ${
          isDesktopSidebarOpen ? "w-64 border-r" : "w-0 border-none"
        }`}
      >
