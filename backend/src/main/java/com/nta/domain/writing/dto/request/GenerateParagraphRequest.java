...
public class GenerateParagraphRequest {
    ...
    @Schema(description = "Writing type", example = "AI_GENERATED", defaultValue = "AI_GENERATED", allowableValues = {"BASIC", "IELTS_TASK1", "IELTS_TASK2", "EMAIL", "AI_GENERATED", "CUSTOM_TEXT"})
    String writingType;
}
